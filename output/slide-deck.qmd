...
::: nonincremental
-   Download <!-- TODO: Add link to script file -->
...
-   Stage and commit you new script
...
::: nonincremental
-   Download <!-- TODO: Add link to data file -->
...
6.  Anything ***necessary to reproduce*** your outcomes (\*)
...
::: notes
6.  E.g. the `renv.lock` file, which stores the environment state
:::
...
-   More security for your GitHub account: [Adding a new SSH key to your GitHub
